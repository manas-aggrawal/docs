...
const config: Config = {
  title: "Crypto Dash Doc",
  tagline: "See the crypto prices yoohoo!",
  ...
  organizationName: "manas-aggrawal", // Usually your GitHub org/user name.
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: "GitHub",
              href: "https://github.com/manas-aggrawal",
            },
          ],
        },
      ],
